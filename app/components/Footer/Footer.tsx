      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#about" className="text-white text-lg hover:text-green-400 transition"> {/* Changed text to white */}
              About Us
            </a></li>
            <li><a href="#programs" className="text-white text-lg hover:text-green-400 transition"> {/* Changed text to white */}
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#faqs" className="text-white text-lg hover:text-green-400 transition"> {/* Changed text to white */}
              FAQs
            </a></li>
            <li><a href="/PrivacyPolicy" className="text-white text-lg hover:text-green-400 transition"> {/* Changed text to white */}
              Privacy Policy
            </a></li>
            <li>
              <Link href="/TermsandConditions" className="text-white text-lg hover:text-green-400 transition"> {/* Changed text to white */}
                Terms & Conditions
              </Link>
            </li>
            <li>
              <Link href="/CancellationRefundPolicy" className="text-white text-lg hover:text-green-400 transition"> {/* Changed text to white */}
