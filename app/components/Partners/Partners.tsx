...
const Partners = () => {
  return (
    <div className="py-8">
      ...
      <h6 className="text-3xl font-bold text-center mb-10 text-white relative">
        Our Trusted Partners
        <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-78 h-1 bg-blue-500 mt-1"></span>
      </h6>
